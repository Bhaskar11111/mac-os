...
const Spotify = ({windowState,setWindowState,windowName,zIndex,bringToFront}) => {
  return (
    <>
    <CollapseWindow windowName={windowName} windowState={windowState} setWindowState={setWindowState} zIndex={zIndex} bringToFront={bringToFront} x='450' y='170' h={80} >
